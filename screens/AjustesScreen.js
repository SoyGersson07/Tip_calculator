    ...
    <SafeAreaView style={s.safe}>
      ...
      >
        ...
        <View style={s.card}>
          ...
          <RowItem
            icon={<Text style={s.emoji}>💳</Text>}           // Icono de tarjeta
        ...
        <View style={s.card}>
          ...
          <RowItem
            icon={<Text style={s.emoji}>🌙</Text>}           // Icono de luna
            title="Tema Oscuro"
          ...
          <RowItem
            icon={<Text style={s.emoji}>🌐</Text>}           // Icono globo terráqueo
            title="Idioma"
        ...
        <View style={s.card}>
          ...
          <RowItem
            icon={<Text style={s.emoji}>❓</Text>}           // Icono pregunta
          ...
          <RowItem
            icon={<Text style={s.emoji}>✉️</Text>}           // Icono sobre
            title="Contáctanos"
